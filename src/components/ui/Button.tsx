  ...
  if (variant === 'curtain-up' || variant === 'curtain-down') {
    ...
    return (
      ...
      >
        ...
        <HiArrowRight className={cn('absolute left-1/2 top-1/2 -translate-x-1/2 text-primary transition-transform duration-800 aspect-square shrink-0 size-6', isDown ? '-translate-y-24 group-hover:-translate-y-1/2' : 'translate-y-24 group-hover:-translate-y-1/2')} />
      </Comp>
    );
  }
